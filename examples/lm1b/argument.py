...
def add_transformer_args(parser):
    ...
    parser.add_argument('--encoder-embed-dim', type=int, default=256, # originally 512 but 64 for char level
                        help='encoder embedding dimension')
    parser.add_argument('--encoder-ffn-embed-dim', type=int, default=2048, # originally 2048 but scaled for char level
    ...
    parser.add_argument('--decoder-embed-dim', type=int, default=256, # originally 512 but 64 for char level
                        help='decoder embedding dimension')
    parser.add_argument('--decoder-ffn-embed-dim', type=int, default=2048, # originally 2048 but scaled for char level
